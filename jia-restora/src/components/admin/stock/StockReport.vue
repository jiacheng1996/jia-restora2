              ...
              <v-card>
                ...
                <v-list dense class="pukulist">
                  ...
                  <v-list-tile>
                    ...
                    <v-list-tile-content class="align-end"><b>{{currency}}{{total_stock_amount}}</b></v-list-tile-content>
                  </v-list-tile>
                </v-list>
              </v-card>
            </v-flex>
                  ...
                  <v-flex lg12>
                    <v-card color="orange">
                      <v-card-title primary-title>
                        <h1 class="white--text">Stock Report</h1>
                        <div class="white--text">
                          <h4>Total Amount of Current Stock : {{currency}}{{total_stock_amount}}</h4>
                        </div>
                      </v-card-title>
                      <v-card-actions>
                        <v-btn flat :to="{name: 'Items'}" style="background:#FFA41E;color:#FFF;">Check All Items</v-btn>
                      </v-card-actions>
                    </v-card>
                  </v-flex>
                  <v-flex lg12>
                    <v-card color="primary" class="white--text">
                      <v-card-title primary-title>
                        <h1 class="white--text">Monthly Stock Record of {{current_year}}</h1>
                        <div class="white--text">
                          <h5> Note: Updated stock will save at current month </h5><br>
                          <h4>January : <span class="monthy_total">{{currency}}{{stock_total_january}}</span></h4>
                          <h4>February : <span class="monthy_total">{{currency}}{{stock_total_february}}</span></h4>
                          <h4>March : <span class="monthy_total">{{currency}}{{stock_total_march}}</span></h4>
                          <h4>April : <span class="monthy_total">{{currency}}{{stock_total_april}}</span></h4>
                          <h4>May : <span class="monthy_total">{{currency}}{{stock_total_may}}</span></h4>
                          <h4>June : <span class="monthy_total">{{currency}}{{stock_total_june}}</span></h4>
                          <h4>July : <span class="monthy_total">{{currency}}{{stock_total_july}}</span></h4>
                          <h4>August : <span class="monthy_total">{{currency}}{{stock_total_august}}</span></h4>
                          <h4>September : <span class="monthy_total">{{currency}}{{stock_total_september}}</span></h4>
                          <h4>October : <span class="monthy_total">{{currency}}{{stock_total_october}}</span></h4>
                          <h4>November : <span class="monthy_total">{{currency}}{{stock_total_november}}</span></h4>
                          <h4>December : <span class="monthy_total">{{currency}}{{stock_total_december}}</span></h4>
                          <h3>Current Stock: <span class="monthy_total">{{currency}}{{stock_total_year}}</span></h3>
                        </div>
                      </v-card-title>
                    </v-card>
                  </v-flex>
